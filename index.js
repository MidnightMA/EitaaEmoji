// =====================================================
// RAZAK MANDATORY CHANNELS — ROTATION INDEX
...
//   حذف:     خط مربوطه را از آرایه‌ی order زیر پاک کن (لازم نیست فایلش را
//            هم حذف کنی؛ یا ساده‌تر: در فایل خودِ کانال enabled:false بگذار).
